...
// Naming 5 places
let favoritePlaces: string[] = ["Dubai", "Saudi Arabia", "London", "Switzerland", "Turkey"]
...
let sortedPlaces = ["Dubai", "Saudi Arabia", "London", "Switzerland", "Turkey"]
sortedPlaces.sort();
