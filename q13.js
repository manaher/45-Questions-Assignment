...
var brand = ["Honda", "Toyota", "Nissan", "Mitsubishi", "Ferrari"];
var message = "i would like to own a";
console.log("I would like to own a ".concat(brand[0], " car"));
// ------------------OR---------------------
...
// add ki
// MAP METHOD
brand.map(function (item) { return console.log("I would like to own a", item); });
